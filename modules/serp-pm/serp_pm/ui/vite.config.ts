...
/**
 * Vite configuration for building PM module UI bundle
 *
        ...
        rollupOptions: {
            ...
            output: {
                ...
                footer: `
                    ...
                    if (typeof window !== 'undefined' && window.__SERP_MODULE_REGISTRY__ && typeof SerpPmModule !== 'undefined') {
                        window.__SERP_MODULE_REGISTRY__.register('pm', SerpPmModule);
                    }
                `,
            },
        },
