...
/**
 * Vite configuration for building Common module UI bundle
 *
    ...
    build: {
        ...
        rollupOptions: {
            ...
            output: {
                ...
                // Note: SerpCommonModule is the local variable created by the IIFE,
                // NOT window.SerpCommonModule. The footer runs in the same scope as the IIFE.
                footer: `
                    // Auto-register module when loaded
                    if (typeof window !== 'undefined' && window.__SERP_MODULE_REGISTRY__ && typeof SerpCommonModule !== 'undefined') {
                        window.__SERP_MODULE_REGISTRY__.register('common', SerpCommonModule);
                    }
                `,
            },
        },
